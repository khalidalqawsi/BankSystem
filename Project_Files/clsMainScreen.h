...
private:
    ...
    static void _ShowAddNewClientsScreen()
    {
        ...
        clsAddNewClientScreen::ShowAddNewClientScrenn();
    }

    static void _ShowDeleteClientScreen()
    {
        // cout << "\nDelete Client Screen Will be here...\n";
        clsDeleteClientScreen::ShowDeleteClientScrenn();
    }

    static void _ShowUpdateClientScreen()
    {
        // cout << "\nUpdate Client Screen Will be here...\n";
        clsUpdateClientScreen::ShowUpdateClientScrenn();
    }

    static void _ShowFindClientScreen()
    {
        // cout << "\nFind Client Screen Will be here...\n";
        clsFindClientScreen::ShowFindClientScrenn();
    }
...
public:
    static void ShowMainMenue()
    {
        ...
        cout << setw(37) << left << "" << "\t[8] Loging Register.\n";
